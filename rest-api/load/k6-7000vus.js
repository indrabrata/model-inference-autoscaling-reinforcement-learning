  ...
  scenarios: {
    predict_progressive: {
      ...
      stages: [
        ...
        { target: 1500, duration: "4m" },
        { target: 3500, duration: "4m" },
    ...
    cpu_memory_chaos: {
      ...
      stages: [
        { target: 800, duration: "4m" },
        { target: 2200, duration: "3m" },
        { target: 3500, duration: "1m" },
        { target: 5000, duration: "4m" },
        { target: 3800, duration: "3m" },
...
export function cpuMemoryMix() {
  ...
  if (rand < 0.45) {
    ...
    analyzeRequest();
    sleep(0.5); // increased from 0.3 for realism
    predictLoad();
  }
}
